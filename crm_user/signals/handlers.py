...
# Add Receiver for setting permissions on new Admin creation
@receiver(post_save, sender=Admin)
def admin_set_permissions(sender, **kwargs):
    """
    Set object-level permissions. 
    The admin user can view, change, and delete the object, 
    The Admin group can view, change, and delete the object,
    The Employee - Manager group can view the object,
    """
    ...
    if created and user.email != settings.ANONYMOUS_USER_NAME:      
        ...
        perms = [view_perm, change_perm, delete_perm]
        ...
        # Assign Employee - Manager Group view permissions
        group, created = Group.objects.get_or_create(name='Employee - Manager')
        assign_perm(view_perm, group, user)
