...
# Create a TestCase for EmployeeCreationForm Labels 
# crm_user.tests.forms.test_EmployeeCreationForm.FormLabelTests 
class FormLabelTests(TestCase):
    """ Define a TestCase for EmployeeCreationForm Labels """
    def setUp(self):
...
class FormHelpTests(TestCase):
    ...
    def test_employee_field_password2_help_text(self):
