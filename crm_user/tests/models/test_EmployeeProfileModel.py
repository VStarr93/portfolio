...
class OneToOneTests(TestCase):
    ...
    def test_user_one_to_one_on_delete(self):
        ...
        self.user.delete()
        self.assertEqual(Employee.objects.filter(email='doe@example.com').exists(), False)
        self.assertEqual(EmployeeProfile.objects.filter(user=self.user).exists(), False)
...
class MethodTests(TestCase):
    ...
    def test_calc_work_id_method(self):
        ...
        self.assertEqual(self.profile.work_id, 10001)
...
class MetaTests(TestCase):
    ...
    def test_verbose_name(self):
        ...
        self.assertEqual(self.profile._meta.verbose_name, 'Employee Profile')
        
    def test_verbose_name_plural(self):
        """ Test Employee Profile Model Verbose Name Plural """
        self.assertEqual(self.profile._meta.verbose_name_plural, 'Employee Profiles')
